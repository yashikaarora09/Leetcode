<h2><a href="https://leetcode.com/problems/prime-arrangements/description/">1279. Prime Arrangements</a></h2><h3>Easy</h3><hr><p>Return the number of permutations of 1 to <code>n</code> so that prime numbers are at prime indices (1-indexed.)</p>
